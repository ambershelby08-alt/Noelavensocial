...
| All bottom-sheet drawers | 60 | CommentsDrawer, SparkModal, ShareSheet, PostMenu, EditPost |
...
Any new fixed overlay in Home.tsx must use `z-[60]`. Any new overlay that should appear above drawers (e.g. a confirmation dialog) must use `z-[70]` or higher. Never add `z-50` to a new sheet.

  ...
  return (
    <div className="min-h-screen bg-black">
      ...
      <div className="sticky top-0 z-40 bg-black/95 backdrop-blur-sm border-b border-[#1a1a1a] px-4 pt-safe pt-4 pb-3 flex items-center gap-3">
        ...
        <h1 className="text-[18px] font-black text-white">Privacy Policy</h1>
      </div>
      ...
      <div className="max-w-2xl mx-auto px-5 py-8 space-y-8 text-[15px] text-[#BDBDBD] leading-relaxed pb-20">
        ...
        <section>
          <h2 className="text-[17px] font-bold text-white mb-3">1. Information We Collect</h2>
          <h3 className="font-semibold text-white mb-1">Account data</h3>
          <p className="mb-3">
          ...
          <h3 className="font-semibold text-white mb-1">User content</h3>
          <p className="mb-3">
        ...
        <section>
          <h2 className="text-[17px] font-bold text-white mb-3">2. How We Use Your Information</h2>
        ...
        <section>
          <h2 className="text-[17px] font-bold text-white mb-3">3. Third-Party Services</h2>
        ...
        <section>
          <h2 className="text-[17px] font-bold text-white mb-3">4. Push Notifications</h2>
          <p>
        ...
        <section>
          <h2 className="text-[17px] font-bold text-white mb-3">5. Data Retention</h2>
          <p>
        ...
        <section>
          <h2 className="text-[17px] font-bold text-white mb-3">6. Your Rights</h2>
        ...
        <section>
          <h2 className="text-[17px] font-bold text-white mb-3">7. Children's Privacy</h2>
          <p>
        ...
        <section>
          <h2 className="text-[17px] font-bold text-white mb-3">8. Changes to This Policy</h2>
          <p>
        ...
        <section>
          <h2 className="text-[17px] font-bold text-white mb-3">9. Contact Us</h2>
          <p>
